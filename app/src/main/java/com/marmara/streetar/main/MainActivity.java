...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.all) {
            ...
            MainPresenter.arPoints = HomeFragment.mainPresenter.getPlaces("",MainPresenter.location);
            return true;
        }if (id == R.id.restaurant) {
            Toast.makeText(this,"Restaurants are loading...",Toast.LENGTH_SHORT).show();
            MainPresenter.arPoints = HomeFragment.mainPresenter.getPlaces("restaurant",MainPresenter.location);
            return true;
        }if (id == R.id.bank){
            Toast.makeText(this,"Banks are loading...",Toast.LENGTH_SHORT).show();
            MainPresenter.arPoints = HomeFragment.mainPresenter.getPlaces("bank",MainPresenter.location);if (id == R.id.cafe) {
                return true;
            }
        }if (id == R.id.school) {
            Toast.makeText(this,"Schools are loading...",Toast.LENGTH_SHORT).show();
            MainPresenter.arPoints = HomeFragment.mainPresenter.getPlaces("school",MainPresenter.location);
            return true;
        }if (id == R.id.hospital) {
            Toast.makeText(this,"Hospitals are loading...",Toast.LENGTH_SHORT).show();
            MainPresenter.arPoints = HomeFragment.mainPresenter.getPlaces("hospital",MainPresenter.location);
            return true;
        }if (id == R.id.cafe) {
            Toast.makeText(this,"Cafes are loading...",Toast.LENGTH_SHORT).show();
            MainPresenter.arPoints = HomeFragment.mainPresenter.getPlaces("cafe",MainPresenter.location);
            return true;
        }
